...
public final class ReadWithScanner {
	...
	/**
	  ...
	  */
	  ...
	  static public void getDataFile(File aFile,File soilFile,String SoilName,String pathname, double lat, double lon ,int i,String WeatherFile, String year, String century) throws FileNotFoundException, IOException{
	  ...
	  public void WriteCropInput(String soil,String pathname, double lat, double lon, int i, String WeatherFile, String year, String century , String Crop) {
		    try
		    {
		    	...
		    	File testFile = new File(pathname+"/soil.sol");
		    	File inputFile = new File(pathname+"/DSSAT40_"+Crop+".INP");
		    	System.out.println(inputFile);
